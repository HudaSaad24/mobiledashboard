...
from pages import Odyssey_Social_Media
...
.menulogo {{
 ...
 .header-link {{
   ...
   <h2 class="heading">Social Media</h2>
    <h2 class="mobileHeading">Odyssey3D</h2> 
...
with col2:
    if st.session_state.current_page == "Odyssey_Social_Media":
        button_style = "active-button"
    else:
        button_style = "default-button"
...
st.markdown("""
    <hr style="display:none border: 0px solid #191B2;">
""", unsafe_allow_html=True)
...
components.html(ody_second_html_code, height=1000,scrolling=True)
# time.sleep(60)
